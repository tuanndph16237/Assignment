...
})({"dQ5qr":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _firebaseConstants = require("./constant/FirebaseConstants");
var _firebaseConstantsDefault = parcelHelpers.interopDefault(_firebaseConstants);
var _urlhelper = require("./helper/Urlhelper");
var _urlhelperDefault = parcelHelpers.interopDefault(_urlhelper);
$(document).ready(function() {
    const categoryService = new _categoryserviceDefault.default(_firebaseConstantsDefault.default.realtimeDB, "Token");
    const url = location.href;
    const urlhelper = new _urlhelperDefault.default();
    const id = urlhelper.readParam(url, 'id');
    const categoryIdCtrl = $("#categoryId");
    const nameCtrl = $("#name");
    _categoryserviceDefault.default.findbyId.then((data)=>{
        const { name  } = data;
        categoryIdCtrl.val(id);
        nameCtrl.val(name);
    });
    $("#update").on("click", ()=>{
        const cate = new _categoryDefault.default(null, nameCtrl.val());
        try {
            _categoryserviceDefault.default.updateCategory(categoryIdCtrl.val(), cate).then((data)=>{
...
},{"regenerator-runtime/runtime":"dXNgZ","./models/Category":"fOVWS","./service/Categoryservice":"hYSJ3","./constant/FirebaseConstants":"ihcHN","./helper/Urlhelper":"8KrXe","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{}],"hYSJ3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class CategoryService {
    ...
    insertCategory = async (id, entity)=>{
        const response = await _axiosDefault.default.post(this.realtimeDb + this.collectionName, entity);
        const insertedId = await response.data.name;
        return insertedId;
    };
    updateCategory = async (id, entity)=>{
        const response = await _axiosDefault.default.put(`${this.realtimeDB}${id}categories/${id}.json`, entity);
    ...
    findAllCategories = async (entity)=>{
        const response = await _axiosDefault.default.get(this.realtimeDb + this.collectionName);
        return response.data;
    };
    findAllCategories = async (entity)=>{
        const response = await _axiosDefault.default.get(this.realtimeDb + this.collectionName);
...
},{"./../utils":"5By4s"}],"ihcHN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = FirebaseConstants = {
    realtimeDB: "https://ecma-9ee8e-default-rtdb.firebaseio.com/"
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8KrXe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Urlhelper {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dQ5qr","lnEw9"], "lnEw9", "parcelRequirebc44")

//# sourceMappingURL=index.1908293b.js.map
